...
const contacts = [
  { icon: "Mail", label: "mg@cbat.org.br", link: "mailto:mg@cbat.org.br" },
  { icon: "MessageSquare", label: "(31) 99815-2403", link: "https://wa.me/5531998152403" },
];
    ...
    <div style={{ background: COLORS.primaryDark, padding: "7px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
      ...
      <div style={{ display: "flex", gap: 20 }}>
        {contacts.map((c, i) => (
          ...
          ><span><Icon name={c.icon} size={12} /></span> {c.label}</a>
        ))}
      </div>
    </div>
  );
