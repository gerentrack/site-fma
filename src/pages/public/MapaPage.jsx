...
const CIDADES_MG = {
  "Abaeté":                     { lat: -19.1558, lng: -45.4444 },
  "Araguari":                   { lat: -18.6486, lng: -48.1867 },
  "Araxá":                      { lat: -19.5932, lng: -46.9406 },
  "Barbacena":                  { lat: -21.2256, lng: -43.7711 },
  "Belo Horizonte":             { lat: -19.9167, lng: -43.9345 },
  "Betim":                      { lat: -19.9678, lng: -44.1983 },
  "Bicas":                      { lat: -21.7231, lng: -43.0592 },
  "Bom Despacho":               { lat: -19.7339, lng: -45.2514 },
  "Brumadinho":                 { lat: -20.1514, lng: -44.2008 },
  "Carlos Chagas":              { lat: -17.7075, lng: -40.7728 },
  "Chiador":                    { lat: -21.9989, lng: -43.0614 },
  "Conceição do Mato Dentro":   { lat: -19.0369, lng: -43.4250 },
  "Congonhas":                  { lat: -20.4997, lng: -43.8578 },
  "Conselheiro Pena":           { lat: -19.1783, lng: -41.4744 },
  "Contagem":                   { lat: -19.9317, lng: -44.0536 },
  "Coronel Fabriciano":         { lat: -19.5208, lng: -42.6278 },
  "Coronel Pacheco":            { lat: -21.5889, lng: -43.2564 },
  "Descoberto":                 { lat: -21.4572, lng: -42.9672 },
  "Diamantina":                 { lat: -18.2494, lng: -43.6003 },
  "Divinópolis":                { lat: -20.1386, lng: -44.8853 },
  "Dores do Turvo":             { lat: -20.9783, lng: -43.1828 },
  "Formiga":                    { lat: -20.4644, lng: -45.4264 },
  "Goianá":                     { lat: -21.5369, lng: -43.1953 },
  "Governador Valadares":       { lat: -18.8511, lng: -41.9494 },
  "Guarani":                    { lat: -21.3553, lng: -43.0328 },
  "Ibituruna":                  { lat: -21.1528, lng: -44.7497 },
  "Ipatinga":                   { lat: -19.4594, lng: -42.5367 },
  "Itabira":                    { lat: -19.6203, lng: -43.2267 },
  "Itabirinha":                 { lat: -18.5383, lng: -41.2339 },
  "Itabirito":                  { lat: -20.2525, lng: -43.8019 },
  "Itatiaiaçu":                 { lat: -20.3950, lng: -44.4350 },
  "Itamonte":                   { lat: -22.2864, lng: -44.8681 },
  "Itanhandu":                  { lat: -22.2956, lng: -44.9344 },
  "Itaúna":                     { lat: -20.0756, lng: -44.5764 },
  "Ituiutaba":                  { lat: -18.9692, lng: -49.4642 },
  "Iturama":                    { lat: -19.7267, lng: -50.1964 },
  "Janaúba":                    { lat: -15.8028, lng: -43.3089 },
  "Juiz de Fora":               { lat: -21.7642, lng: -43.3503 },
  "Lagoa Santa":                { lat: -19.6286, lng: -43.8908 },
  "Lavras":                     { lat: -21.2453, lng: -45.0000 },
  "Lima Duarte":                { lat: -21.8392, lng: -43.7942 },
  "Mantena":                    { lat: -18.7769, lng: -40.9858 },
  "Mariana":                    { lat: -20.3778, lng: -43.4161 },
  "Matozinhos":                 { lat: -19.5564, lng: -44.0867 },
  "Monte Carmelo":              { lat: -18.7253, lng: -47.4950 },
  "Montes Claros":              { lat: -16.7286, lng: -43.8619 },
  "Naque":                      { lat: -19.2283, lng: -42.3311 },
  "Nova Lima":                  { lat: -19.9858, lng: -43.8467 },
  "Nova Serrana":               { lat: -19.8764, lng: -44.9856 },
  "Ouro Preto":                 { lat: -20.3855, lng: -43.5031 },
  "Pará de Minas":              { lat: -19.8611, lng: -44.6069 },
  "Paracatu":                   { lat: -17.2225, lng: -46.8711 },
  "Patos de Minas":             { lat: -18.5789, lng: -46.5178 },
  "Patrocínio":                 { lat: -18.9439, lng: -46.9928 },
  "Pedro Leopoldo":             { lat: -19.6181, lng: -44.0431 },
  "Piedade de Caratinga":       { lat: -19.7578, lng: -42.0756 },
  "Piumhi":                     { lat: -20.4761, lng: -45.9569 },
  "Poços de Caldas":            { lat: -21.7869, lng: -46.5618 },
  "Ponte Nova":                 { lat: -20.4153, lng: -42.9028 },
  "Pouso Alegre":               { lat: -22.2300, lng: -45.9369 },
  "Prados":                     { lat: -21.0589, lng: -44.0769 },
  "Ribeirão das Neves":         { lat: -19.7692, lng: -44.0853 },
  "Rio Novo":                   { lat: -21.4667, lng: -43.1133 },
  "Rio Pomba":                  { lat: -21.2744, lng: -43.1781 },
  "Rio Preto":                  { lat: -22.0869, lng: -43.8286 },
  "Rochedo de Minas":           { lat: -21.6283, lng: -43.0186 },
  "Santa Rita de Ibitipoca":    { lat: -21.5642, lng: -43.9553 },
  "Santana do Paraíso":         { lat: -19.3672, lng: -42.5456 },
  "Santana do Riacho":          { lat: -19.1683, lng: -43.7142 },
  "São Domingos do Prata":      { lat: -19.8700, lng: -42.9706 },
  "São Geraldo":                { lat: -20.9225, lng: -42.8361 },
  "São João del Rei":           { lat: -21.1311, lng: -44.2619 },
  "São José da Lapa":           { lat: -19.7003, lng: -43.9547 },
  "São Sebastião do Paraíso":   { lat: -20.9169, lng: -46.9911 },
  "Serra do Curral":            { lat: -19.9633, lng: -43.9550 },
  "Sete Lagoas":                { lat: -19.4658, lng: -44.2481 },
  "Tabuleiro":                  { lat: -21.3636, lng: -43.2392 },
  "Teófilo Otoni":              { lat: -17.8575, lng: -41.5053 },
  "Timóteo":                    { lat: -19.5833, lng: -42.6444 },
  "Tiradentes":                 { lat: -21.1128, lng: -44.1756 },
  "Três Corações":              { lat: -21.6944, lng: -45.2553 },
  "Uberaba":                    { lat: -19.7475, lng: -47.9315 },
  "Uberlândia":                 { lat: -18.9186, lng: -48.2772 },
  "Varginha":                   { lat: -21.5515, lng: -45.4303 },
  "Vespasiano":                 { lat: -19.6919, lng: -43.9219 },
  "Viçosa":                     { lat: -20.7539, lng: -42.8822 },
  "Visconde do Rio Branco":     { lat: -21.0125, lng: -42.8406 },
};
...
function coordsFromCidade(cidade) {
  ...
  const key = Object.keys(CIDADES_MG).find(k => cn.includes(norm(k)) || norm(k).includes(cn));
