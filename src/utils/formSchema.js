...
export const FORM_SECTIONS = {
  ...
  tecnico:       { id: "tecnico",       title: "Aspectos Técnicos",                 tipo: "both" },
  ...
  seguros:       { id: "seguros",       title: "Seguro e Regulamentação",           tipo: "chancela" },
};
...
export const PERMIT_FIELDS_DEFAULT = [
  ...
  // ── Financeiro ────────────────────────────────────────────────────────
  { id: "valorInscricao",             label: "Valor da Inscrição",                  type: "currency", section: "financeiro",     required: true,  active: true, builtin: true, order: 10 },
  ...
  { id: "valorPremiacaoTotal",        label: "Valor Total da Premiação",            type: "currency", section: "financeiro",     required: false, active: true, builtin: true, order: 30, conditional: "premiacaoDinheiro" },
  ...
  { id: "certificadoMedicao",         label: "Certificado de Medição do Percurso",  type: "upload",   section: "tecnico",        required: true,  active: true, builtin: true, order: 40, accept: ".pdf,.jpg,.png", hint: "Certificado emitido pelo medidor oficial da CBAt/Federação", conditionalValue: { field: "formaMedicaoPercurso", value: "Medição Oficial (Roda Medidora / Jones Counter)" } },
  { id: "formaMedicaoOutro",          label: "Descreva a forma de aferição",        type: "text",     section: "tecnico",        required: true,  active: true, builtin: true, order: 45, hint: "Informe como o percurso foi medido", conditionalValue: { field: "formaMedicaoPercurso", value: "Outro" } },
...
export function validarCamposConfig(ct, tipo) {
  ...
  fields.forEach(f => {
    ...
    if (f.conditionalValue && ct[f.conditionalValue.field] !== f.conditionalValue.value) return;
